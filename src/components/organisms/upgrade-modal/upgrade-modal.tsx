...
export default function Component() {
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="lg:flex lg:justify-center lg:items-center max-h-[90vh] lg:max-h-[95vh] overflow-auto max-w-6xl border-none p-0 outline-none ring-0 focus:border-none focus:outline-none focus:ring-0 active:outline-none">
        <div className="lg:flex lg:flex-col lg:justify-center lg:items-center lg:h-screen h-full bg-[#0c1824] p-10 text-white">

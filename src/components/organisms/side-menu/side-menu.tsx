      ...
      <nav className="mt-8 flex flex-col items-start pl-4 ">
        {isSearchOpen ? (
          ...
          <>
            ...
            <button className="mt-8 flex w-11/12 lg:w-10/12 items-center justify-center gap-2 rounded-md bg-gradient-to-r from-[#40B6FC] to-[#0089DB] px-4 py-3 text-white transition hover:opacity-90 active:scale-95 active:bg-gradient-to-r active:from-[#0089DB] active:to-[#40B6FC]">
